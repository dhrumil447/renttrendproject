...
const navigate =  useNavigate()
  ...
  return (
    <div className='container mt-5 col-11'>
        ...
        onClick={()=>navigate('/supplier/categories/add')} className='btn btn-primary btn-lg float-end mt-2'>Add</button></h1><hr />
     <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              onClick={()=>navigate(`/supplier/category/edit/${cat.id}`)}><FaPenAlt/></button>
...
export default SupplierViewCategory
